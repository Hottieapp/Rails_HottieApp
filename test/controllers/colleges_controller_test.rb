...
class CollegesControllerTest < ActionController::TestCase
  ...
  test "should create college" do
    assert_difference('College.count') do
      post :create, college: { Address: @college.Address, Fest_Date: @college.Fest_Date, Fest_name: @college.Fest_name, Name: @college.Name }
    end
  ...
  test "should update college" do
    patch :update, id: @college, college: { Address: @college.Address, Fest_Date: @college.Fest_Date, Fest_name: @college.Fest_name, Name: @college.Name }
    assert_redirected_to college_path(assigns(:college))
  end
